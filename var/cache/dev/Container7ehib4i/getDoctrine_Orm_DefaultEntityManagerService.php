...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ReclamationBundle\\Entity')]);

$b->addDriver($c, 'UserBundle\\Entity');
$b->addDriver($c, 'ReclamationBundle\\Entity');
...
$a->setEntityNamespaces(['UserBundle' => 'UserBundle\\Entity', 'ReclamationBundle' => 'ReclamationBundle\\Entity']);
